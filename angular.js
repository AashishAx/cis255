...
app1.controller('ctrl1', function($scope) {
  ...
  //hypoteneous function
  $scope.updateHyp = function(){
		$scope.hyp =Math.sqrt(+$scope.first*+$scope.first + +$scope.second*+$scope.second);
...
//random course generator 1
app1.controller('ran_crs1', function($scope) {
	var course = ["CIS255", "CIS355", "CS331", "CS411", "CS357"];
	$scope.randomcourse1 = course[Math.floor((Math.random()*5))];
});
//random course generator 2
app1.controller('ran_crs2', function($scope) {
	var course = ["CIS255", "CIS355", "CS331", "CS411", "CS357", "CS146", "CS245", "CS116", "CS216", "CS311"];
	$scope.randomcourse2 = course[Math.floor((Math.random()*10))];
});

//ordered list of 10 courses
app1.controller('ordlst', function($scope) {
	$scope.courselst = [{coursen:"CIS255"}, {coursen:"CIS355"}, {coursen:"CS331"}, {coursen:"CS411"}, {coursen:"CS357"}, {coursen:"CS146"}, {coursen:"CS245"}, {coursen:"CS116"}, {coursen:"CS216"}, {coursen:"CS311"}];
	//$scope.randomcourse2 = course[Math.floor((Math.random()*10))];
